...
//        audioClip.play();
    ...
    public void initialize() {
        var product1 = new Product("id1", " Product 1 test", "Amazon", 80.00, null, 80, null, " Product 1 description. Product 1 description. Product 1 description. Product 1 description. Product 1 description. Product 1 description. Product 1 description. ", null);
        var product2 = new Product("id2", " Product 2 test", "Amazon", 90.00, null, 80, null, " Product 2 description. Product 2 description. Product 2 description. Product 2 description. Product 2 description. Product 2 description. Product 2 description.", null);
        var product3 = new Product("id3", " Product 3 test", "Amazon", 60.00, null, 0, null, "Product 3 description. Product 3 description. Product 3 description. Product 3 description. Product 3 description. Product 3 description. Product 3 description.", null);
        var product4 = new Product("id4", " Product 4 test", "Amazon", 40.00, null, 0, null, "Product 4 description. Product 4 description. Product 4 description. Product 4 description. Product 4 description. Product 4 description. Product 4 description.", null);
        var product5 = new Product("id5", " Product 5 test", "Amazon", 20.00, null, 0, null, "Product 5 description. Product 5 description. Product 5 description. Product 5 description. Product 5 description. Product 5 description. Product 5 description.", null);
        var product6 = new Product("id6", " Product 6 test", "Amazon", 800.00, null, 80, null, "Product 6 description. Product 6 description. Product 6 description. Product 6 description. Product 6 description. Product 6 description. Product 6 description.", null);
        var product7 = new Product("id7", " Product 7 test", "Amazon", 50.00, null, 80, null, "Product 7 description. Product 7 description. Product 7 description. Product 7 description. Product 7 description. Product 7 description. Product 7 description.", null);
        product1.setRating(new ArrayList<>(Arrays.asList(new Rate(null, product1, 5))));
        product2.setRating(new ArrayList<>(Arrays.asList(new Rate(null, product2, 4))));
        product3.setRating(new ArrayList<>(Arrays.asList(new Rate(null, product3, 3))));
        product1.addComment(new Comment(Controller.getCurrentAccount(), product1, "sadsad", "comment 1", Status.APPROVED, true));
//      var item1 = new ItemOfOrder(null,product1,80.00,0,new Date());
//        var item2 = new ItemOfOrder(null,product2,90.00,0,new Date());
//        var item3 = new ItemOfOrder(null,product3,60.00,0,new Date());
//        var item4 = new ItemOfOrder(null,product4,40.00,0,new Date());
//        var item5 = new ItemOfOrder(null,product5,20.00,0,new Date());
//        var item6 = new ItemOfOrder(null,product6,800.00,0,new Date());
//        var item7 = new ItemOfOrder(null,product7,50.00,0,new Date());
//        new BuyerLog(Arrays.asList(item1,item2,item3,item4,item5,item6,item7));
    ...
    private void updateListToMap() {
        ...
        for (Product product : products) {
            ...
            switch (rate) {
                case 0:
                    singleProduct.getRateImage().setImage(new Image(String.valueOf(Main.class.getResource("0star.png"))));
                    break;
                case 1:
                    singleProduct.getRateImage().setImage(new Image(String.valueOf(Main.class.getResource("1star.png"))));
                    break;
                case 2:
                    singleProduct.getRateImage().setImage(new Image(String.valueOf(Main.class.getResource("2star.png"))));
                    break;
                case 3:
                    singleProduct.getRateImage().setImage(new Image(String.valueOf(Main.class.getResource("3star.png"))));
                    break;
                case 4:
                    singleProduct.getRateImage().setImage(new Image(String.valueOf(Main.class.getResource("4star.png"))));
                    break;
                case 5:
                    singleProduct.getRateImage().setImage(new Image(String.valueOf(Main.class.getResource("5star.png"))));
                    break;
            }
