...
class RateSortTest {
    ...
    void applyAscendingSort() {
        List<Product> actual = rateSort.applySort(new ArrayList<>(Arrays.asList(p1, p2, p3, p4)), true);
        List<Product> expected = new ArrayList<>(new ArrayList<>(Arrays.asList(p4, p1, p3, p2)));
    ...
    void applyDescendingSort() {
        List<Product> actual = rateSort.applySort(Arrays.asList(p1, p2, p3, p4), false);
        List<Product> expected = Arrays.asList(p2, p3, p1, p4);
